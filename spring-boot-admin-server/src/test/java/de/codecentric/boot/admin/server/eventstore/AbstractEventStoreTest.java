...
public abstract class AbstractEventStoreTest {
  ...
  private final Registration registration =
      Registration.create("foo", "http://health").metadata("test", "dummy").build();
  ...
  public void should_store_events() {
    ...
    InstanceEvent eventOther =
        new InstanceRegisteredEvent(InstanceId.of("other"), 0L, now.plusMillis(10), registration);
  ...
  public void should_throw_optimictic_locking_exception() {
    ...
    StepVerifier.create(store.append(singletonList(event1b)))
  ...
  public void concurrent_read_writes() {
    ...
    StepVerifier.create(
            eventgenerator
                .subscribeOn(Schedulers.newSingle("a"))
