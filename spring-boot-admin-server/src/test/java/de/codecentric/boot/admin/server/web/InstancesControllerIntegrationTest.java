...
public class InstancesControllerIntegrationTest {
  ...
  private ParameterizedTypeReference<Map<String, Object>> RESPONSE_TYPE =
  ...
  public void setUp() {
    instance =
        new SpringApplicationBuilder()
            .sources(AdminReactiveApplicationTest.TestAdminApplication.class)
    ...
    this.register_as_test =
        "{ \"name\": \"test\", \"healthUrl\": \"http://localhost:"
            + localPort
            + "/application/health\" }";
    this.register_as_twice =
        "{ \"name\": \"twice\", \"healthUrl\": \"http://localhost:"
            + localPort
            + "/application/health\" }";
  }
  ...
  private String register() {
    ...
    EntityExchangeResult<Map<String, Object>> result =
        client
            ...
            .contentType(MediaType.APPLICATION_JSON)
            .expectHeader()
            .valueMatches("location", "http://localhost:" + localPort + "/instances/[0-9a-f]+")
