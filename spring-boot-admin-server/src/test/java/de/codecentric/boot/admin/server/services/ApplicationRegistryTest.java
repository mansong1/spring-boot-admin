...
public class ApplicationRegistryTest {
  ...
  public void setUp() {
    ...
    this.applicationRegistry =
        new ApplicationRegistry(this.instanceRegistry, instanceEventPublisher);
  }
  ...
  public void getStatus(
      String instance1Status, String instance2Status, String expectedApplicationStatus) {
    ...
    StepVerifier.create(this.applicationRegistry.getApplications())
        ...
        .consumeRecordedWith(
            (applications) ->
                assertThat(applications.stream().map(Application::getStatus))
  ...
  private Instance getInstance(String applicationName, String version) {
    Registration registration =
        Registration.create(applicationName, "http://localhost:8080/health")
