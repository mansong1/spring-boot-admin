...
public class NotificationFilterControllerTest {
  ...
  private final NotificationFilterController controller =
      new NotificationFilterController(
  ...
  public void test_post_delete() throws Exception {
    String response =
        this.mvc
            .perform(post("/notifications/filters?instanceId=1337&ttl=10000"))
    ...
    this.mvc
        .perform(get("/notifications/filters"))
        .andExpect(status().isOk())
