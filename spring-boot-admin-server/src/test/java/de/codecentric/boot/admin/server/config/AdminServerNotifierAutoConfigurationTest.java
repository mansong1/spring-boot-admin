...
public class AdminServerNotifierAutoConfigurationTest {
  ...
  public void test_notifierListener() {
    this.contextRunner
        .withUserConfiguration(TestSingleNotifierConfig.class)
        .run(
            (context) -> {
  ...
  public void test_no_notifierListener() {
    this.contextRunner.run(
        (context) -> assertThat(context).doesNotHaveBean(NotificationTrigger.class));
  }
  ...
  public void test_hipchat() {
    this.contextRunner
        .withPropertyValues("spring.boot.admin.notify.hipchat.url:http://example.com")
  ...
  public void test_letschat() {
    this.contextRunner
        .withPropertyValues("spring.boot.admin.notify.letschat.url:http://example.com")
  ...
  public void test_slack() {
    this.contextRunner
        .withPropertyValues("spring.boot.admin.notify.slack.webhook-url:http://example.com")
  ...
  public void test_pagerduty() {
    this.contextRunner
        .withPropertyValues("spring.boot.admin.notify.pagerduty.service-key:foo")
  ...
  public void test_opsgenie() {
    this.contextRunner
        .withPropertyValues("spring.boot.admin.notify.opsgenie.api-key:foo")
  ...
  public void test_ms_teams() {
    this.contextRunner
        .withPropertyValues("spring.boot.admin.notify.ms-teams.webhook-url:http://example.com")
  ...
  public void test_discord() {
    this.contextRunner
        .withPropertyValues("spring.boot.admin.notify.discord.webhook-url:http://example.com")
  ...
  public void test_multipleNotifiers() {
    this.contextRunner
        .withUserConfiguration(TestMultipleNotifierConfig.class)
        .run(
            (context) -> {
  ...
  public void test_multipleNotifiersWithPrimary() {
    this.contextRunner
        .withUserConfiguration(TestMultipleWithPrimaryNotifierConfig.class)
        .run(
            (context) -> {
              assertThat(context.getBean(Notifier.class)).isInstanceOf(TestNotifier.class);
  ...
  public void test_notifierProxyProperties() {
    this.contextRunner
        .withPropertyValues("spring.boot.admin.notify.proxy.host")
