...
/**
 * Returns a new HttpHeaders from the given one but omits the hop-by-hop headers and specified
 * headers.
 *
...
public class HttpHeaderFilter {
  ...
  public HttpHeaderFilter(Set<String> ignoredHeaders) {
    this.ignoredHeaders =
        Stream.concat(ignoredHeaders.stream(), Arrays.stream(HOP_BY_HOP_HEADERS))
