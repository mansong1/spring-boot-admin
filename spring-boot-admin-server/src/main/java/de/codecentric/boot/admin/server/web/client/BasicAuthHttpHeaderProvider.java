 ...
 * "user.password".
 *
 * <p>Other allowed key names: - "user-name" / "user-password" - "username" / "userpassword"
 *
...
public class BasicAuthHttpHeaderProvider implements HttpHeadersProvider {
  ...
  public static class InstanceCredentials {
    ...
    @lombok.NonNull private String userName;

    /** user password for this instance */
    @lombok.NonNull private String userPassword;
  }
}
