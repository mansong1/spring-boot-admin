...
public class SpringBootAdminHazelcastApplication {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(SpringBootAdminHazelcastApplication.class);
  ...
  public Config hazelcastConfig() {
    ...
    MapConfig eventStoreMap =
        new MapConfig(DEFAULT_NAME_EVENT_STORE_MAP)
    ...
    MapConfig sentNotificationsMap =
        new MapConfig(DEFAULT_NAME_SENT_NOTIFICATIONS_MAP)
            .setInMemoryFormat(InMemoryFormat.OBJECT)
            .setBackupCount(1)
            .setEvictionConfig(
                new EvictionConfig()
                  ...
                  csrf.csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse())
                      ...
                      .ignoringRequestMatchers(
                          new AntPathRequestMatcher(
                              this.adminServer.path("/instances"), HttpMethod.POST.toString()),
                          new AntPathRequestMatcher(
                              this.adminServer.path("/instances/*"), HttpMethod.DELETE.toString()),
