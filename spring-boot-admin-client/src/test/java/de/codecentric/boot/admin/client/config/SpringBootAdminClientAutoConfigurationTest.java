...
public class SpringBootAdminClientAutoConfigurationTest {
  ...
  public void not_active() {
    this.contextRunner.run(
        (context) -> assertThat(context).doesNotHaveBean(ApplicationRegistrator.class));
  }
  ...
  public void nonWebEnvironment() {
    ApplicationContextRunner nonWebcontextRunner =
  ...
  public void reactiveEnvironment() {
    ReactiveWebApplicationContextRunner reactiveContextRunner =
