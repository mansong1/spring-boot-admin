...
public class CloudFoundryMetadataContributorTest {
  ...
  public void should_return_empty_metadata() {
    CloudFoundryMetadataContributor contributor =
        new CloudFoundryMetadataContributor(new CloudFoundryApplicationProperties());
  ...
  public void should_return_metadata() {
    ...
    CloudFoundryMetadataContributor contributor =
        new CloudFoundryMetadataContributor(cfApplicationProperties);
    assertThat(contributor.getMetadata())
        .containsEntry("applicationId", "appId")
        .containsEntry("instanceId", "1");
  }
}
