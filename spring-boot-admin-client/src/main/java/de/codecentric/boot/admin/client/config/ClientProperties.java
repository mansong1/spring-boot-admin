...
public class ClientProperties {
  ...
  /**
   * Enable automatic deregistration on shutdown If not set it defaults to true if a active {@link
   * CloudPlatform} is present;
   */
  ...
  public boolean isAutoDeregistration(Environment environment) {
    return (this.autoDeregistration != null)
        ? this.autoDeregistration
