...
public class UiExtensionsScannerTest {
  ...
  private final UiExtensionsScanner scanner =
      new UiExtensionsScanner(new PathMatchingResourcePatternResolver());
  ...
  public void should_find_extensions() throws IOException {
    ...
    assertThat(extensions.getCssExtensions())
        .contains(
            new UiExtension(
                "custom/custom.abcdef.css",
                "classpath:/META-INF/test-extensions/custom/custom.abcdef.css"));

    assertThat(extensions.getJsExtensions())
        .contains(
            new UiExtension(
                "custom/custom.abcdef.js",
