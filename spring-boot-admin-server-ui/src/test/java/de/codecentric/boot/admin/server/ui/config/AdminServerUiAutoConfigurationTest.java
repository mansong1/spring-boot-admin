  ...
  public class ReactiveUiConfigurationTest {
    ...
    private final ReactiveWebApplicationContextRunner contextRunner =
        new ReactiveWebApplicationContextRunner()
            .withPropertyValues(
                "--spring.boot.admin.ui.available-languages=de", "--spring.webflux.base-path=test")
    ...
    @ParameterizedTest
    @CsvSource({
      "/test/extensions/myextension",
      "/test/instances/1/actuator/heapdump",
    ...
    public void contextPathIsRespectedInExcludedRoutes(String routeExcludes) {
      MockServerHttpRequest serverHttpRequest =
          MockServerHttpRequest.get(routeExcludes)
      ...
      this.contextRunner
          .withUserConfiguration(
              SpringBootAdminServerEnabledCondition.class,
    ...
    public void contextPathIsRespectedInIncludedRoutes(String routeIncludes) {
      MockServerHttpRequest serverHttpRequest =
          MockServerHttpRequest.get(routeIncludes)
              .header(HttpHeaders.ACCEPT, MediaType.TEXT_HTML_VALUE)
              .build();
  ...
  public class ServletUiConfiguration {
    ...
    public void contextPathIsRespectedInExcludedRoutes(String routeExcludes) {
      MockHttpServletRequest httpServletRequest =
          spy(new MockHttpServletRequest("GET", routeExcludes));
      ...
      this.contextRunner
          ...
          .run(
              (context) -> {
                de.codecentric.boot.admin.server.ui.web.servlet.HomepageForwardingFilter bean =
                    context.getBean(
                        de.codecentric.boot.admin.server.ui.web.servlet.HomepageForwardingFilter
                            .class);
                bean.doFilter(
                    httpServletRequest, mock(ServletResponse.class), mock(FilterChain.class));
    ...
    public void contextPathIsRespectedInIncludedRoutes(String routeIncludes) {
      MockHttpServletRequest httpServletRequest =
          spy(new MockHttpServletRequest("GET", routeIncludes));
      httpServletRequest.addHeader(HttpHeaders.ACCEPT, MediaType.TEXT_HTML_VALUE);
                ...
                de.codecentric.boot.admin.server.ui.web.servlet.HomepageForwardingFilter bean =
                    context.getBean(
                        de.codecentric.boot.admin.server.ui.web.servlet.HomepageForwardingFilter
                            .class);
                bean.doFilter(
                    httpServletRequest, new MockHttpServletResponse(), mock(FilterChain.class));
