...
export const applications = [{
  ...
  instances: [{
    ...
    registration: {
      ...
      source: 'http-api',
      metadata: { startup: '2021-10-29T08:50:07.486289+02:00', 'tags.environment': 'test' }
    },
    registered: true,
    statusInfo: {
      status: 'UP',
      details: {
        db: {
          status: 'UP',
          details: { database: 'HSQL Database Engine', validationQuery: 'isValid()' }
        },
        diskSpace: {
          status: 'UP',
          details: { total: 499963174912, free: 108980899840, threshold: 10485760, exists: true }
        },
        ping: { status: 'UP' }
      }
    },
    ...
    endpoints: [{ id: 'sessions', url: 'http://localhost:8080/actuator/sessions' }, {
      id: 'httptrace',
