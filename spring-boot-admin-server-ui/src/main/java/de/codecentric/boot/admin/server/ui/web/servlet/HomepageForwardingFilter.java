...
/**
 * A servlet filter that forwards matching HTML requests to the home page. Further routing will is
 * done in the browser by VueRouter using history mode.
 *
 * @see <a href="https://router.vuejs.org/guide/essentials/history-mode.html">VueRouter history
 *     mode</a>
 */
public class HomepageForwardingFilter implements Filter {
  ...
  public HomepageForwardingFilter(
      String homepage, List<String> routes, List<String> excludedRoutes) {
