...
public class AdminServerUiProperties {
  ...
  /**
   * If running behind a reverse proxy (using path rewriting) this can be used to output correct
   * self references. If the host/port is omitted it will be inferred from the request.
   */
  ...
  /**
   * Limit languages to this list. Intersection of all supported languages and this list will be
   * used.
   */
