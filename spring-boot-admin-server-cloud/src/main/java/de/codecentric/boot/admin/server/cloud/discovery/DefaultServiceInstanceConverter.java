 ...
 * respectively. If you want to influence the url per service you can add <code>management.scheme
 * </code>, <code>management.address</code>, <code>management.port</code>, <code>
 * management.context-path</code> or <code>health.path</code> to the instances metadata.
 *
...
public class DefaultServiceInstanceConverter implements ServiceInstanceConverter {
  ...
  private static final Logger LOGGER =
      LoggerFactory.getLogger(DefaultServiceInstanceConverter.class);
  ...
  /**
   * Default context-path to be appended to the url of the discovered service for the managment-url.
   */
  ...
  protected URI getManagementUrl(ServiceInstance instance) {
    ...
    if (serviceUrl.getHost().equals(managementHost)
        && serviceUrl.getScheme().equals(managementScheme)
  ...
  protected String getManagementPath(ServiceInstance instance) {
    String managementPath =
        instance.getMetadata().get(DefaultServiceInstanceConverter.KEY_MANAGEMENT_PATH);
